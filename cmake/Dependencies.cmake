    ...
    if(NOT (X265_FOUND AND X264_FOUND AND OPENH264_FOUND AND LIBAVCODEC_FOUND AND LIBAVUTIL_FOUND AND FDKAAC_FOUND AND LIBCURL_FOUND AND RTMP_LIBYUV_TARGET AND LIBDE265_FOUND))
        ...
        if(RTMP_APT_GET_BIN AND CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
            ...
            if(RTMP_UID STREQUAL "0")
                ...
                if(NOT X265_FOUND)
                    list(APPEND RTMP_MISSING_APT_PACKAGES libx265-dev)
                endif()
                if(NOT X264_FOUND)
                    list(APPEND RTMP_MISSING_APT_PACKAGES libx264-dev)
                endif()
                ...
                if(NOT LIBCURL_FOUND)
                    list(APPEND RTMP_MISSING_APT_PACKAGES libcurl4-openssl-dev)
                endif()
                if(NOT RTMP_LIBYUV_TARGET)
                    list(APPEND RTMP_MISSING_APT_PACKAGES libyuv-dev)
                endif()
                if(NOT LIBDE265_FOUND)
                    list(APPEND RTMP_MISSING_APT_PACKAGES libde265-dev)
                endif()
